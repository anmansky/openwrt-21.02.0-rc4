...
ifeq ($(DUMP),1)
  ...
  CPU_CFLAGS = -O3 -funsafe-math-optimizations -funroll-loops -ffunction-sections -fdata-sections -Wl,--gc-sections -pipe
  ...
  ifeq ($(ARCH),aarch64)
    CPU_TYPE ?= generic
    CPU_CFLAGS_generic = -mcpu=cortex-a72.cortex-a53+crypto
